...
FUNCTION(INTERNAL_ADD_DEPENDENCY ad_name)
	...
	IF (${ARGC} EQUAL 2)
		LIST(GET ARGV 1 ARG2)
		IF(${ARG2} STREQUAL "HEADERS_ONLY")
			SET(ONLY_HEADERS 1)
		ENDIF()
	ENDIF()
	...
	IF("${ad_name}_FOUND")
		...
		IF (NOT ONLY_HEADERS)
			message("linking ${${ad_name}_LIBRARIES}")
...
FUNCTION(INTERNAL_REMOVE_DUPLICATES)	
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_MODULE_TEST_FILES)
	...
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_MODULE_SOURCE_FILES)	
	...
	LIST(REVERSE GLOBAL_TEST_LIBS)
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_TEST_LIBS)
	LIST(REVERSE GLOBAL_TEST_LIBS)
	SET(GLOBAL_TEST_LIBS 	${GLOBAL_TEST_LIBS}        CACHE INTERNAL "collect test libs")
	
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_TEST_SOURCE)
	SET(GLOBAL_TEST_SOURCE  ${GLOBAL_TEST_SOURCE}	CACHE INTERNAL "collect test source")
	
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_TEST_INCLUDE_DIRECTORIES)
	SET(GLOBAL_TEST_INCLUDE_DIRECTORIES ${GLOBAL_TEST_INCLUDE_DIRECTORIES}	CACHE INTERNAL "collect test include directories")
	
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_TEST_LINKER_DIRECTORIES)
	SET(GLOBAL_TEST_LINKER_DIRECTORIES  ${GLOBAL_TEST_LINKER_DIRECTORIES}  CACHE INTERNAL "collect test linker directories")
	
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_PACKAGE_FOUND)
	...
	INTERNAL_REMOVE_LIST_DUPLICATES(GLOBAL_CMAKE_PROJECTS)
